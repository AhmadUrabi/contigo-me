        ...
        <div className="lg:w-3/4 xl:w-2/3 w-full mx-auto lg:my-4 ease-in-out transition-all mb-16 md:mb-0 pb-4">
          <div className="md:bg-gradient-to-tr md:from-gray-200 md:to-gray-50 bg-transparent /*p-6*/ shadow-2xl rounded-lg md:pb-4">
            <div className="flex justify-center md:justify-between items-center p-6">
              ...
              <a className="w-full justify-end hidden md:flex" href="https://www.jh.com.jo" rel="noreferrer" target="_blank"><button className="shadow-md md:w-1/3 p-4 bg-[#231f20] rounded-md md:mb-4 md:mx-4 mt-2 text-gray-100 text-lg md:hover:bg-zinc-600 transition-all ease-in-out">Become a Distributor</button></a>
            </div>
            {children}
