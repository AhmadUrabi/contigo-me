...
const countryList = [
  ...
  { name: 'Kuwait', flag: KuwaitFlag, url: '/Kuwait', hidden: false },
    ...
    <main>
      ...
      <div className="w-full flex justify-evenly align-center flex-wrap py-9">
        {countryList.map((country, index) => (
          <a key={index} href={country.url} className={country.hidden ? "w-full md:w-auto pointer-events-none cursor-default" : "w-full md:w-auto"}>
